...
class NickProtossBot(sc2.BotAI):
    def __init__(self):
    ...
    async def build_workers(self):
        optProbesPerNexus = len(self.units(NEXUS)) * 16 > len(self.units(PROBE))
        if optProbesPerNexus and len(self.units(PROBE)) < self.MAX_WORKERS:
